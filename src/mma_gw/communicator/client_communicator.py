...
class ClientCommunicator:
    """
    Streaming communicator for federated learning clients.
    ...
    def on_server_started(self, data):
        ...
        print(
            f"[Detector {self.client_agent.get_id()}] Received ServerStarted event.",
            flush=True,
        )
        self.logger.info(
            f"[Detector {self.client_agent.get_id()}] Received ServerStarted event."
    ...
    def send_embeddings_inference(self, local_embeddings, **kwargs):
        """
        Send local embeddings to the server for inference via streaming framework
