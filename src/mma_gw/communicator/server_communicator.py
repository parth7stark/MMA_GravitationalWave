...
class ServerCommunicator:
    """
    Streaming communicator for federated learning server.
    ...
    def handle_embeddings_message(self, data):
        ...
        self.server_agent.aggregator.process_embeddings_message(
            batch_id, shift, det_id, local_embedding
        )
    ...
    def handle_post_process_message(self, data):
        ...
        self.server_agent.aggregator.process_post_process_message(
            self.producer, self.topic, det_id, status, GPS_start_time
        )
