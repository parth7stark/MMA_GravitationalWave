...
#SBATCH --job-name=MMA_GW_TestContainer_VFL_client1_CPU    # job name
#SBATCH --time=02:00:00                         # dd-hh:mm:ss for the job

#SBATCH -e MMA_GW_TestContainer_VFL_client1_CPU-err-%j.log
#SBATCH -o MMA_GW_TestContainer_VFL_client1_CPU-out-%j.log
...
# python3 ./grpc/run_vfl_client.py --config ./configs/vfl/client1.yaml

cd /scratch/bcbw/parthpatel7173/MMA_GravitationalWave

apptainer exec --nv \
  GW_miniapp_delta.sif \
  python /app/examples/octopus/run_detector.py --config /scratch/bcbw/parthpatel7173/MMA_GravitationalWave/examples/configs/client1_container.yaml
