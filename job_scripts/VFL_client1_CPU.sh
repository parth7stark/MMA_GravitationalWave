...
#SBATCH --job-name=MMA_GW_Test_VFL_client1    # job name
#SBATCH --time=01:00:00                         # dd-hh:mm:ss for the job

#SBATCH -e MMA_GW_Test_VFL_client1-err-%j.log
#SBATCH -o MMA_GW_Test_VFL_client1-out-%j.log
...
# Start detector 0 -- update config before starting

python3 ./examples/octopus/run_detector.py --config ./examples/configs/client1.yaml
